                ...
                <div className="space-y-4 md:space-y-6">
                        ...
                        <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-2">
                            <div>
                                <h2 className="text-xl md:text-2xl font-light text-white mb-1">
                                    <a href="https://dawsonpartners.com/" target="_blank" rel="noopener noreferrer" className="hover:underline">Dawson Partners</a>
                                </h2>
                                <p className="text-base md:text-lg text-gray-300/90 font-light mb-1">Software Developer</p>
                            </div>
                            <div className="text-right mt-2 md:mt-0">
                                <p className="text-xs md:text-sm text-gray-400">Jan 2026 – Ongoing</p>
                                <p className="text-xs md:text-sm text-gray-500 italic flex items-center md:justify-end">
                                    <span className="mr-1">📍</span> Toronto, Ontario
                                </p>
                    ...
                    <div className="bg-black/20 backdrop-blur-sm rounded-xl p-6 md:p-8 relative border border-transparent hover:border-white/20 transition-all duration-300">
                        <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-2">
                            <div>
                                <h2 className="text-xl md:text-2xl font-light text-white mb-1">
                                    <a href="https://covalensedigital.com/" target="_blank" rel="noopener noreferrer" className="hover:underline">Covalense Digital</a>
                                </h2>
                                <p className="text-base md:text-lg text-gray-300/90 font-light mb-1">Software Engineer Intern</p>
                            </div>
                            <div className="text-right mt-2 md:mt-0">
                                <p className="text-xs md:text-sm text-gray-400">May 2025 – Aug. 2025</p>
                                <p className="text-xs md:text-sm text-gray-500 italic flex items-center md:justify-end">
                        ...
                        <div className="mt-4 space-y-3 text-sm md:text-base text-gray-300/90 font-light">
                            <p>Developed and demoed a secure, RBAC-enabled internal MCP system that lets users search and interact with data in natural language while respecting access permissions.</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-black/20 backdrop-blur-sm rounded-xl p-6 md:p-8 relative border border-transparent hover:border-white/20 transition-all duration-300">
                        <div className="flex flex-col md:flex-row md:justify-between md:items-start">
                            <div>
                                <h2 className="text-xl md:text-2xl font-light text-white mb-1">
                                    <a href="https://watai.ca/" target="_blank" rel="noopener noreferrer" className="hover:underline">Wat.AI</a>
                                </h2>
